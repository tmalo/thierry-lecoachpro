...
export default function AProposPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="mb-6 text-lg leading-relaxed text-gray-700">
                <strong>Je vous écoute comme on écoute un poème</strong> : avec
                attention, respect et la conscience que tout ne peut pas être
                compris immédiatement. Mon approche s&apos;appuie sur une écoute
                sensible, qui cherche à entendre les nuances autant que ce qui
                est explicite.
              </p>
      ...
      <Section>
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="mb-6 text-lg leading-relaxed text-gray-700">
                L&apos;<strong>action</strong> que je propose se veut à la fois{" "}
                <strong>stratégique</strong> — alignée avec votre direction —{" "}
                <strong>et fluide</strong> — intégrée à votre quotidien.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="p-6 text-center">
              ...
              <p className="leading-relaxed text-gray-600">
                Une attention particulière aux nuances et aux non-dits de votre
                discours, comme on écoute un poème.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-primary/5 border-primary/10 rounded-lg border p-8">
            <p className="prose text-left text-lg leading-relaxed text-gray-700">
              ...
              cette créativité que seule la sérénité peut offrir, pour continuer
              à écrire le poème de votre vie.
            </p>
          </div>
        </div>
      </Section>
      ...
      {/* Quote Section */}
      <CtaSection
        description="Chaque proposition d'action est pensée comme une note de musique : libre à vous de voir si elle résonne, de la jouer ou de la transformer"
        quote
      >
